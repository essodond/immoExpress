#!/usr/bin/env python3
"""Setup script to manually create all backend and frontend structure."""
import os
import sys
...
backend_files[os.path.join(base_backend, "package.json")] = '''{
  "name": "immo-backend",
  "version": "1.0.0",
...
backend_files[os.path.join(base_backend, ".env.example")] = '''DATABASE_URL="postgresql://user:password@localhost:5432/immo_db"
...
backend_files[os.path.join(base_backend, ".gitignore")] = '''node_modules/
.env
dist/
*.log
.DS_Store
...
backend_files[os.path.join(base_backend, "prisma", "schema.prisma")] = '''generator client {
...
backend_files[os.path.join(base_backend, "prisma", "seed.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "utils", "cloudinary.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "utils", "jwt.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "middleware", "authMiddleware.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "middleware", "validate.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "middleware", "errorHandler.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "controllers", "authController.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "controllers", "maisonController.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "controllers", "uploadController.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "routes", "auth.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "routes", "maisons.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "routes", "upload.js")] = """'use strict';
...
backend_files[os.path.join(base_backend, "src", "server.js")] = """'use strict';
...
# Create frontend .gitkeep files for empty directories
frontend_files = {}
for dir_path in frontend_dirs:
    frontend_files[os.path.join(dir_path, ".gitkeep")] = ""
